...
/**
 * Loads config file defined in environment as node module.
 *
 * @api private
 */
function getConfig() {
  // get the config file path from env variable
  var configPath = process.env.NODE_MONGOOSE_MIGRATIONS_CONFIG;
  var configObject = require(path.join(process.cwd(), configPath));
